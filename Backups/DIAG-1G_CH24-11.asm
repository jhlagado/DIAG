...
#include "DIAGs_1-Equates_v11.asm"
#include "DIAGs_2-Shadow_v11.asm"
...
; Similar to 8x8Scan above, but outputs 24 bytes to an RGB 8x8.
; HL to contain start of screen data, with
...
repScan:
	push hl
    push hl
	ld c,80h	    ; 8 rows of data to display

rowScan:
		ld a,(hl)	    ; Load A with Red Data
	out (ex8XR),a
    add HL, $08     ; Set HL to Green Data
	ld a,(hl)
	out (ex8XG),a
    add HL, $08     ; Set HL to Blue Data
	ld a,(hl)
	out (ex8XB),a
...
onex8:	djnz onex8
    ...
    pop hl          ; Retrieve the Saved HL that points to the Red data byte
	inc hl		    ; Point to the next byte of Red data

    rr c		    ; next row down
	jr nc, rowScan

	pop hl          ; Retrieve the HL that pointed to the START of the screen (Red) data

	dec d
	jr nz,repScan   ; and repeat the top to bottom scan again for d amount of scans
...
#include "DIAGs_4-GLCD_v11.asm"
#include "DIAGs_5-Pi_v11.asm"
#include "DIAGs_6-Music_v11.asm"
#include "DIAGs_7-Matrix_v11.asm"
#include "DIAGs_8-FTDI_v11.asm"
#include "DIAGs_9-RTC_v11.asm"
#include "DIAGs_10-SD_v11.asm"
#include "DIAGs_11-Strings_v11.asm"
